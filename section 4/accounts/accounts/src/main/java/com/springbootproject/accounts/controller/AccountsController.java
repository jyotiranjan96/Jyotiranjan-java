package com.springbootproject.accounts.controller;

import com.springbootproject.accounts.constants.AccountsConstants;
import com.springbootproject.accounts.dto.AccountsContactInfoDto;
import com.springbootproject.accounts.dto.CustomerDto;
import com.springbootproject.accounts.dto.ErrorResponseDto;
import com.springbootproject.accounts.dto.ResponseDto;
...
public class AccountsController {
    ...
    @Operation(summary = "Fetch Account", description = "Fetches account details by mobile number")
    @GetMapping("/fetch")
    ...
    @Operation(summary = "Delete Account", description = "Deletes account by mobile number")
    @ApiResponses({
    ...
    public ResponseEntity<Map<String, Object>> getcontactInfo() {
        ...
        response.put("message", accountsContactInfoDto.getMessage());
        response.put("contactDetails", accountsContactInfoDto.getContactDetails());
        response.put("onCallSupport", accountsContactInfoDto.getOnCallSupport());
